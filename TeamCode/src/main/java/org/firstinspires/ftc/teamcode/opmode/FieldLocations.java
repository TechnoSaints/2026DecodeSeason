...
public class FieldLocations {
    ...
    public final static Pose stack1SetupRightPose = new Pose(87, 72, Math.toRadians(170));
    public final static Pose stack1FinishRightPose = new Pose(125, 72, Math.toRadians(170));
