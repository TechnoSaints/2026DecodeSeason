...
@Autonomous(name="Decode Auto Blue", group="Autonomous")
public class DecodeAutoBlue extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        backRightMotor.setPower(0.70);
        backLeftMotor.setPower(0.49);
        sleep(1200);
