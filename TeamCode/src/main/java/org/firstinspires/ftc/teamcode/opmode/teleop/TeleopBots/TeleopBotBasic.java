...
public class TeleopBotBasic extends Bot {
    ...
    public TeleopBotBasic(OpMode opMode, Telemetry telemetry) {
    ...
    public void processGamepadInput(Gamepad gamepad) throws InterruptedException {
        if (gamepad.dpad_up) {
